...
const Header = () => {
  ...
  return (
    <StyledNavbar expand="lg" variant="light">
      <Container fluid>
        <Link to="/dashbord" className="navbar-brand d-flex align-items-center" style={{ marginRight: '30px' }}>
        ...
        <Nav className="ml-auto d-flex align-items-center">
          <Dropdown show={showNotificationMenu} onToggle={handleNotificationToggle} align="end">
            ...
            <DropdownMenu>
              <Dropdown.Item>La Gautiere N:25 est bien préparer !</Dropdown.Item>
            </DropdownMenu>
          </Dropdown>
          ...
          <Dropdown show={showMenu} onToggle={handleDropdownToggle} align="end">
            ...
            <DropdownMenu>
              <Dropdown.Item href="parametredentiste">
                <FaCog className="mr-2" /> Paramètres
              </Dropdown.Item>
              <Dropdown.Item href="/logindentiste">
