      ...
      <Row className="justify-content-center">
        <Col xs={12} md={8} lg={6}>
          <Card className="shadow-lg">
            <Card.Body>
              <div className="text-center mb-4">
                ...
                <p className="text-muted">Prothésiste</p>
              </div>
                ...
                <Row>
                  <Col sm={12}>
                    <Nav variant="tabs" className="mb-3">
                      <Nav.Item>
                        <Nav.Link eventKey="form">Changer le Mot De Passe</Nav.Link>
                      </Nav.Item>
                    </Nav>
                    <Tab.Content>
          ...
          <div className="mt-3 text-center">
            <p>Vous avez Terminé ? <Link to="/dashbordpro" className="text-primary">Retour au Dashbord</Link></p>
          </div>
        </Col>
      </Row>
    </Container>
