    ...
    <Container className="mt-5">
      <Row className="justify-content-center">
        <Col xs={12} md={6} className="p-4 border rounded shadow-lg">
          <h2 className="text-center mb-4 text-primary">Réinitialiser le mot de passe (Dentinste)</h2>
          ...
          <div className="mt-3 text-center">
            <p>Vous avez Terminer ? <Link to="/logindentiste" className="text-primary">Retour à la connexion</Link></p>
          </div>
        </Col>
      </Row>
    </Container>
